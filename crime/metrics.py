...
if __name__ == "__main__":
    ...
    parser.add_argument("--task_name", default="violent", help="violent or petty")
    parser.add_argument("--prompt_type", default="simple", help="Prompt type")

    args = parser.parse_args()
    model_name_full = args.model_name.replace("/", "_")
    response_path = f'/data5/liutianhui/UrbanSensing/results/crime/{args.task_name}/{args.city_name}/{model_name_full}_{args.prompt_type}_response.json'
    summary_path = f'/data5/liutianhui/UrbanSensing/results/crime/{args.task_name}_summary.csv'
