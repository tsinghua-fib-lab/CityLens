...
if __name__ == "__main__":
    ...
    response_path = f'/data5/liutianhui/UrbanSensing/results/global/{args.task_name}/{args.city_name}/{model_name_full}_{args.prompt_type}_response.json'
    summary_path = f'/data5/liutianhui/UrbanSensing/results/global/{args.task_name}/{args.task_name}_summary.csv'
