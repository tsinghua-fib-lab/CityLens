...
def single_task_gen(city, task_name):
    ...
    task_path = f'/data5/liutianhui/UrbanSensing/data/transport/{city}/{city}_transport_{task_name}_task.json'
...
def eval_task(city, model_name, num_process, prompt_type, task_name):
    if city == "US":
        task_path = f"/data5/liutianhui/UrbanSensing/data/transport/US_transport_{task_name}_task.json"
    else:
        task_path = f'/data5/liutianhui/UrbanSensing/data/transport/{city}/{city}_transport_{task_name}_task.json'
    
    
    model_name_full = model_name.replace("/", "_")
    response_path = f'/data5/liutianhui/UrbanSensing/results/transport/{task_name}/{city}/{model_name_full}_{prompt_type}_response.json'
