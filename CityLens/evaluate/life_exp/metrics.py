...
if __name__ == "__main__":
    ...
    response_path = f'/data5/liutianhui/UrbanSensing/results/life_expectancy/{args.city_name}/{model_name_full}_{args.prompt_type}_life_expectancy_response.json'
    summary_path = f'/data5/liutianhui/UrbanSensing/results/life_expectancy/life_exp_summary.csv'
