...
def data_gen_simple(city):
    data_path = f'/data5/liutianhui/UrbanSensing/data/house_price/UK/{city}_house_price.csv'
    ...
    prompt = f"Suppose you are a professional real estate appraisal expert in {city}, United Kingdom. Based on the provided satellite imagery and several street view photos, please estimate 'house price' in the msoa area where the images are taken. Consider factors such as location, visible property features, neighborhood condition, and any other relevant details."
...
def generate_session_simple(city, data):
    ...
    """
    url_file = f"/data5/liutianhui/ossutil-2.0.3/url_mapping_UK_{city}_20250507_1month.csv"
