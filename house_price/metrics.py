...
if __name__ == "__main__":
    ...
    response_path = f'/data5/liutianhui/UrbanSensing/results/house_price/{args.city_name}/{model_name_full}_{args.prompt_type}_house_price_response.json'
    summary_path = f'/data5/liutianhui/UrbanSensing/results/house_price/house_price_summary.csv'
